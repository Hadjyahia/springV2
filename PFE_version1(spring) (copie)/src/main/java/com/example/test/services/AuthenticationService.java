...
import com.example.test.request.JwtResponse;
import com.example.test.request.LoginRequest;
import com.example.test.security.dtos.UserLoginResponse;
...
public class AuthenticationService {
    ...
    public ResponseEntity<?> loginAppUser( @RequestBody LoginRequest loginRequest) {
